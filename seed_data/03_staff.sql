...
UPDATE users SET federaltaxid='84-1000010', federaldrugid='AO1234567', upin='A10001', state_license_number='MA-15101', weno_prov_id='W10001', billing_facility_id=2, valedictory='Best regards', info='Board-certified Internal Medicine. Practicing telehealth since 2020.' WHERE id=10;
UPDATE users SET federaltaxid='84-1000011', federaldrugid='AR1234567', upin='A10002', state_license_number='MA-15211', weno_prov_id='W10002', billing_facility_id=2, valedictory='Warmly',       info='Board-certified Family Medicine. Focuses on behavioral health in primary care.' WHERE id=11;
...
UPDATE users SET federaltaxid='84-1000030', upin='A10030', state_license_number='CO-MA-55030', billing_facility_id=1, supervisor_id=14, valedictory='Sincerely', info='Certified Medical Assistant.' WHERE id=30;
UPDATE users SET federaltaxid='84-1000031', upin='A10031', state_license_number='MA-MA-55131', billing_facility_id=2, supervisor_id=10, valedictory='Sincerely', info='Certified Medical Assistant.' WHERE id=31;
UPDATE users SET federaltaxid='84-1000032', upin='A10032', state_license_number='MA-RN-44232', billing_facility_id=2, supervisor_id=11, valedictory='Warmly', info='RN with behavioral health experience.' WHERE id=32;
UPDATE users SET federaltaxid='84-1000033', upin='A10033', state_license_number='MO-RN-44333', billing_facility_id=4, supervisor_id=24, valedictory='Warmly', info='RN with primary care experience.' WHERE id=33;
UPDATE users SET federaltaxid='84-1000034', upin='A10034', state_license_number='CA-RN-44434', billing_facility_id=3, supervisor_id=13, valedictory='Warmly', info='RN with chronic disease management experience.' WHERE id=34;
UPDATE users SET federaltaxid='84-1000035', upin='A10035', state_license_number='MO-MA-55235', billing_facility_id=4, supervisor_id=24, valedictory='Sincerely', info='Certified Medical Assistant.' WHERE id=35;
UPDATE users SET federaltaxid='84-1000036', upin='A10036', state_license_number='CA-MA-55336', billing_facility_id=3, supervisor_id=13, valedictory='Sincerely', info='Certified Medical Assistant.' WHERE id=36;
