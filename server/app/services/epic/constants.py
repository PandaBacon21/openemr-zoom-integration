...
# Outbound call cache: maps (account_id, epic_call_id) → openemr_patient_id.
# Populated at initiate-call time; read by ReceiveCommunication3 to drive the
# screen pop without ZCC needing to echo back patientContext. 30 minutes gives
# ample time for the agent to connect even for queued or delayed calls.
EPIC_OUTBOUND_CALL_CACHE_TTL_SECONDS = 1800
